...
def login():
    ...
    elif usernameEntry.get() == 'Vallary' and passwordEntry.get() == '1234':
...
window.title('Login page Student Management System')
window.resizable(False,False)

backgroundImage=ImageTk.PhotoImage(file='roses.jpg')
